<nav class="sb-topnav navbar navbar-expand navbar-light" style="background-color: green">
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="text-white fw-bold nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <li>
                    <a class="dropdown-item" href="logic/logic-logout.php">Logout</a>
                </li>
            </ul>
        </li>
    </ul>
